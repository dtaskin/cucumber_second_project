...
public class SmartBearSteps {
    ...
    public void userEntersAllAddressInformation() {
        orderPage.customerNameInputBox.sendKeys("Deniz taskin");
        orderPage.streetInputBox.sendKeys("1193 main ave");
        orderPage.cityInputBox.sendKeys("clifton");
        orderPage.stateInputBox.sendKeys("nj");
    ...
    public void userEntersAllPaymentInformation() {
        ...
        orderPage.expirationDateInputBox.sendKeys("08/25");
    }
